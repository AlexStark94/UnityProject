...
//    public GameController gameController;
    ...
    public void OnUnityAdsDidFinish(string placementId, ShowResult showResult)
    {
        ...
        if (showResult == ShowResult.Finished)
        {
            ...
            if(placementId.Equals(androidRewardedVideoID) || placementId.Equals(iosRewardedVideoID))
            {
               ...
               // GameController.COINS += rewardCoinsAmount;
                //gameController.UpdateCoinsTexts();
            }
        }
    ...
    public void ShowRewardedVideo(int rewardAmount)
    {

        Debug.Log("Show rewarded Video");

        rewardCoinsAmount = rewardAmount;
